...
| Item | Version / decision | Status |
|---|---|---|
| Product requirements | PRD v1.0.0 | Frozen |
| Design | Design v1.0.0 + SaaS Foundation v1.1.0 | Accepted for implementation planning |
| Starter package | v1.0.1 | Current |
| Java | 21 | Accepted |
| Spring Boot | 4.1.0 | Accepted |
| Spring AI | 2.0.0 | Accepted |
