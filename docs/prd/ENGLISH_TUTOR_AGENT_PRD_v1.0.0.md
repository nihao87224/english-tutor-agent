...
> 文档版本：`1.0.0`  
> 文档状态：`产品需求正式基线`  
> 产品阶段：`产品需求已冻结，概要设计与详细设计已完成，进入编码准备`  
> 更新日期：`2026-07-21`  
> 主要客户端：`Android`  
...
> 元数据修订说明：本次仅更新项目阶段状态，产品需求基线内容仍为 `v1.0.0`。
...
| D-012 | 第一版训练形态 | Android 同时支持文字、语音和听力 |
| D-013 | 核心训练方向 | 口语交流为主，综合英语能力为辅，场景动态决定 |
...
| D-021 | IELTS 范围 | 第一版支持完整 IELTS Speaking 训练与参考评分 |
