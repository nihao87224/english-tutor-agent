...
CREATE TABLE user_audio_asset (
    id BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    asset_key VARCHAR(96) NOT NULL UNIQUE,
    user_id BIGINT NOT NULL,
...
CREATE TABLE role_play_turn (
    ...
    accepted_at_utc TIMESTAMP(3) NOT NULL,
    completed_at_utc TIMESTAMP(3),
    created_at_utc TIMESTAMP(3) NOT NULL,
    updated_at_utc TIMESTAMP(3) NOT NULL,
    version BIGINT NOT NULL,
